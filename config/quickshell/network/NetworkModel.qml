...
Scope {
    ...
    readonly property var selectedWifi: root.selectedWifiIndex >= 0 && root.selectedWifiIndex < root.wifiNetworks.length
        ? root.wifiNetworks[root.selectedWifiIndex]
        : null
    readonly property bool networkOffline: root.statusText.indexOf("offline") >= 0
        || root.statusText.indexOf("unavailable") >= 0
